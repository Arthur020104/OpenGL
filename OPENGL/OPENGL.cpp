...
unsigned int compileShaders()
{
    ...
    "void main()\n"
    "{\n"
    "FragColor = vec4(0.7f, 0.9f,0.0f,1.0f);\n"
    "}\n";
    /*********************Shader Compilation*******************************/
...
int main()
{
    ...
    Mac OS X you need to add glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); to your initialization code for it to work*/
